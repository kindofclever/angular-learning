...
export type ServicesPageSchema = {
  _id: string;
...
export type ProcedurePageSchema = {
  _id: string;
...
export type ImpressionsPageSchema = {
  _id: string;
